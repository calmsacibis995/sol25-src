...
#pragma ident	"@(#)synch.h	1.31	95/08/24 SMI"
...
typedef struct _sema {
	...
	uint32_t	type;
	uint64_t	pad1[3];	/* reserved for a mutex_t */
	uint64_t 	pad2[2];	/* reserved for a cond_t */
} sema_t;
...
typedef struct _rwlock {
	uint32_t	readers;	/* -1 == writer else # of readers */
	uint32_t	type;
	uint64_t	pad1[3];	/* internal consistency mutex */
	uint64_t	pad2[2];	/* really cond_t for readers */
	uint64_t	pad3[2];	/* really cond_t for writers */
} rwlock_t;
 ...
 */
#define	DEFAULTMUTEX	{0, 0, 0, 0, USYNC_THREAD, 0, 0, 0, 0, 0, 0, 0, 0, 0}
#define	SHAREDMUTEX	{0, 0, 0, 0, USYNC_PROCESS, 0, 0, 0, 0, 0, 0, 0, 0, 0}
#define	DEFAULTCV	{0, 0, 0, 0, USYNC_THREAD, 0}
#define	SHAREDCV	{0, 0, 0, 0, USYNC_PROCESS, 0}
#define	DEFAULTSEMA	{0, USYNC_THREAD, 0, 0, 0, 0, 0}
#define	SHAREDSEMA	{0, USYNC_PROCESS, 0, 0, 0, 0, 0}
#define	DEFAULTRWLOCK	{0, USYNC_THREAD, 0, 0, 0, 0, 0, 0, 0}
#define	SHAREDRWLOCK	{0, USYNC_PROCESS, USYNC_PROCESS, 0, 0, USYNC_PROCESS, \
			0, USYNC_PROCESS, 0}
