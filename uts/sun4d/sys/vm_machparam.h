...
#pragma ident	"@(#)vm_machparam.h	1.22	95/01/16 SMI"
 ...
 *	lotsfree is 1/16 of memory, but at most 1024k bytes.
 *	desfree is 1/32 of memory, but at most 400k bytes.
 *	minfree is 1/2 of desfree, but at most 200k bytes.
 */
#define	LOTSFREE	(1024 * 1024)
#define	LOTSFREEFRACT	16
#define	DESFREE		(400 * 1024)
#define	DESFREEFRACT	32
#define	MINFREE		(200 * 1024)
