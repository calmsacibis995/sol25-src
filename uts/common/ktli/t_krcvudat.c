...
/* SVr4.0 1.4  */
#pragma ident	"@(#)t_krcvudat.c	1.11	94/04/13 SMI"
...
#ifdef KTLIDEBUG
{
	...
	while (tp) {
		...
		KTLILOG(2, "db_size %x, ", dmp->db_lim - dmp->db_base);
