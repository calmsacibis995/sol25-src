...
#pragma ident	"@(#)ufs_quota.h	2.27	94/06/28 SMI"
/* SVr4.0 1.5	*/
...
extern int ndquot;
extern krwlock_t dq_rwlock;		/* lock for quota fields in ufsvfs */

extern void qtinit();
extern void qtinit2();
extern struct dquot *getinoquota(struct inode *);
extern int chkdq(struct inode *ip, long, int, struct cred *);
extern int chkiq(struct ufsvfs *, struct inode *, uid_t, int, struct cred *);
...
extern void dqinvalfs(struct ufsvfs *);

extern int quotactl(struct vnode *, int, struct cred *);
