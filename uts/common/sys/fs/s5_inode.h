...
#pragma ident	"@(#)s5_inode.h	1.3	94/04/19 SMI"
...
extern	int	s5_itrunc(struct inode *, u_long, struct cred *);
...
extern	int	s5_freesp(struct vnode *, struct flock *, int, struct cred *);
extern	int	s5_rdwri(enum uio_rw, struct inode *, caddr_t, int, off_t,
    enum uio_seg, int *, struct cred *);
extern	int	s5_bmap_read(struct inode *, u_int, daddr_t *, int *);
extern	int	s5_bmap_write(struct inode *, u_int, int,
    int, struct cred *);
extern void	s5_sbupdate(struct vfs *vfsp);
extern	int	bmap_has_holes(struct inode *);

extern	void	s5_sbwrite(register struct s5vfs *s5vfsp);
extern	void	s5_update(int);
extern	void	s5_flushi(int);
extern	int	s5_syncip(struct inode *, int, int);
extern int	s5_sync_indir(register struct inode *ip);
...
extern	int	isblock(struct filsys *, unsigned char *, daddr_t);
extern	void	setblock(struct filsys *, unsigned char *, daddr_t);
extern	void	clrblock(struct filsys *, u_char *, daddr_t);
