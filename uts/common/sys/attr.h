...
#pragma ident	"@(#)attr.h	1.8	93/11/01 SMI"	/* SunOS 10.19 */
 ...
 */
typedef enum {
    ATTR_LIST = ATTR(ATTR_PKG_GENERIC,
	ATTR_LIST_PTR(ATTR_RECURSIVE, ATTR_NO_VALUE), 0)
} Attr_generic;
...
#define	attr_cu_to_y(encoded_value, font, top_margin, row_gap) \
    attr_rc_unit_to_y(encoded_value, font->pf_defaultsize.y, \
	top_margin, row_gap)
#endif	/* lint */
