...
#pragma ident	"@(#)tiuser.h	1.13	94/12/23 SMI"	/* SVr4.0 11.5 */
...
#define	T_HACK		12		/* (Following ancient comment   */
					/* no longer true but T_HACK is */
					/* useless but exposed interface now) */
					/* ============================ */
