...
#pragma ident	"@(#)mtio.h	2.33	95/06/28 SMI"	/* UCB 4.10 83/01/17 */
...
struct mtdrivetype {
	...
	u_char  densities[MT_NDENSITIES];	/* density codes, low->hi */
	u_char	default_density;	/* Default density chosen */
	u_char  speeds[MT_NSPEEDS];	/* speed codes, low->hi */
};
