...
#pragma ident	"@(#)device.h	1.16	94/08/31 SMI"
...
#else	/* __STDC__ */
extern int scsi_slave(/* struct scsi_device *, (int *)() */);
extern void scsi_unslave(/* struct scsi_device */);
extern int scsi_probe(/* struct scsi_device *devp, int (*callback)() */);
extern void scsi_unprobe(/* struct scsi_device */);
#endif	/* __STDC__ */
#endif	/* _KERNEL */
