...
#pragma ident	"@(#)condvar.h	1.6	94/07/29 SMI"
...
extern	int	cv_timedwait(kcondvar_t *, kmutex_t *, long);
extern	int	cv_wait_sig(kcondvar_t *, kmutex_t *);
extern	int	cv_timedwait_sig(kcondvar_t *, kmutex_t *, long);
extern	int	cv_wait_sig_swap(kcondvar_t *, kmutex_t *);
extern	void	cv_signal(kcondvar_t *);
extern	void	cv_broadcast(kcondvar_t *);
extern  kcondvar_t *cv_alloc(char *, kcv_type_t, void *);
extern  void	cv_free(kcondvar_t *);
