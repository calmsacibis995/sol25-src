#ident	"@(#)vuid_store.c	1.5	93/05/13 SMI"
	...
	Vuid_state client_state;
{
	...
	/* LINTED lint thinks that seg_next may be used before set */
	...
	Vuid_seg *seg;
{
	...
	/* LINTED lint thinks that val_node_next may be used before set */
