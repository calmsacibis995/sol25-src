...
#pragma ident	"@(#)scsi_data.c	1.17	95/02/15 SMI"
 ...
 *
 * XXX:	Note, esp scsi chips will automatically transfer 6, 10, and 12 byte
 *	cdb's.  This structure is used to determine this.  Addition of
 *	any other classes will require fixing esp.c up.
 */
