...
#ident	"@(#)cred.c	1.17	94/12/04 SMI"	/* SVr4.0 1.2	*/
...
cred_init()
{
	...
	mutex_init(&cr_lock, "cred lock", MUTEX_DEFAULT, DEFAULT_WT);
 ...
 */
int
groupmember(register gid_t gid, register cred_t *cr)
{
 ...
 */
int
hasprocperm(register cred_t *tcrp, register cred_t *scrp)
{
 ...
 */
int
crcmp(register cred_t *cr1, register cred_t *cr2)
{
