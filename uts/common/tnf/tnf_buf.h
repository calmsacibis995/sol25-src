...
#pragma ident	"@(#)tnf_buf.h	1.15	95/07/19 SMI"
...
typedef struct {
	...
	u_long			next_tag_alloc;
	u_long			next_fw_alloc;
...
void * tnfw_b_alloc(TNFW_B_WCB *, int, enum tnf_alloc_mode);
...
extern u_long tnfw_b_atomic_swap(u_long *, u_long);
