...
#pragma ident	"@(#)tnf_trace.h	1.14	95/03/21 SMI"
 ...
 * XXX Too large for the kernel: wastes space
 * XXX Merge with TNFW_B_FW_ZONE
 */
...
tnf_uint32_t tnf_probe_tag(tnf_ops_t *, tnf_probe_control_t *);
