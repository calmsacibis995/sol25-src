...
#pragma ident	"@(#)nfs_acl.h	1.1	94/12/05 SMI"
...
#define	NFS_ACL_PROGRAM	((unsigned long)(100227))
#define	NFS_ACL_VERSMIN	((unsigned long)(2))
#define	NFS_ACL_VERSMAX	((unsigned long)(3))

#define	NFS_ACL_V2		((unsigned long)(2))
...
#define	NFS_ACL_V3		((unsigned long)(3))
...
extern int acl2call(mntinfo_t *, int, xdrproc_t, caddr_t,
			xdrproc_t, caddr_t, cred_t *, int *, enum nfsstat *);
extern int acl3call(mntinfo_t *, int, xdrproc_t, caddr_t,
