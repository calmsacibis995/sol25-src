...
#ident	"@(#)float.s	1.37	95/02/08 SMI"
...
#ifndef MP
	ld	[%o4 + CPU_FPOWNER], %o3	! current fpu owner
	cmp	%g3, %o3
	bne	1f				! if not the same, restore and
	nop					! 	fix cpu_fpowner state 
	retl					! otherwise do nothing, fpu
	nop					! 	state already loaded
1:	
#endif	/* !MP */
...
fpeok:
	...
	stb	%l6, [%l3 + MPCB_FPU_QCNT] ! save number of queue entries
	!
