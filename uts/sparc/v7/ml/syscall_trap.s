 ...
 */
#pragma ident	"@(#)syscall_trap.s	1.10	95/02/08 SMI"
...
_syscall_clean:
	...
	!
_syscall_overflow:
	b	_syscall_exit_trap		! call trap with T_AST
	mov	T_WIN_OVERFLOW, %o0		! psr delay
 ...
 */
	...
	mov	%l2, %g2		! pass npc to user code in %g2
#ifdef VIKING_BUG_16
	stbar
#endif /* VIKING_BUG_16 */
	jmp	%l5			! return
