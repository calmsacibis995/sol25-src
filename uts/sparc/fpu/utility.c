...
#ident	"@(#)utility.c	1.17	94/10/12 SMI"	/* SunOS-4.1 1.10 88/12/06 */
	...
	unpacked	*pu;
{
	...
	pu->significand[1] = (u_int)0xffffffff;
	pu->significand[2] = (u_int)0xffffffff;
	pu->significand[3] = (u_int)0xffffffff;
}
