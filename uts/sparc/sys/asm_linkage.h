...
#pragma ident	"@(#)asm_linkage.h	1.31	94/10/24 SMI"
/* from SunOS 4.0 1.4 */
...
#define	TRACE_DUMP_HEAD(event, cpup, headp, time, hrec) \
...
#define	TRACE_DUMP_0(event, cpup, headp, scr1, scr2) \
	TRACE_DUMP_HEAD(event, cpup, headp, scr1, scr2); \
	add	headp, 4, headp; \
