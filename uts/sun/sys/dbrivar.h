...
#pragma ident	"@(#)dbrivar.h	1.42	94/12/22 SMI"
...
#define	DBRI_SYNC_CURINTQ(UNITP) \
	ddi_dma_sync((UNITP)->dma_handle, \
	    ...
	    (off_t)((UNITP)->intq.off * sizeof (uint_t)), \
	    sizeof (uint_t), DDI_DMA_SYNC_FORCPU)
...
struct dbri_unit {
	...
	ulong_t iopbiobase;	/* allocated iopb space for io */
	uint_t iopbsize;	/* size of allocated iopb space */
	 ...
	 */
	int tetimer_id;		/* dbri_te_timer() */
	int nttimer_t101_id;	/* dbri_nttimer_t101() */
	int nttimer_t102_id;	/* dbri_nttimer_t102() */
	int keepalive_id;	/* dbri_keepalive() */
	int mmcvolume_id;	/* mmcodec_volume_timer() */
	int mmcwatchdog_id;	/* mmcodec_watchdog() */
	int mmcdataok_id;	/* mmcodec_data_mode_ok() */
	int mmcstartup_id;	/* mmcodec_startup_audio() */
...
#define	DBRI_IOPBIOADDR(unitp, a) \
	(void *)((unitp)->iopbiobase + \
	    ((ulong_t)(a) - (ulong_t)(unitp)->iopbkbase))

#define	DBRI_IOPBKADDR(unitp, a) \
	(void *)((unitp)->iopbkbase + \
	    ((ulong_t)(a) - (ulong_t)(unitp)->iopbiobase))
 ...
 */
#define	TICKS(MS) (((MS)/Dbri_mshz > 0) ? ((MS)/Dbri_mshz) : 1)
...
extern void dbri_nttimer_t101(caddr_t);
extern void dbri_nttimer_t102(caddr_t);
...
extern void mmcodec_startup_audio(dbri_unit_t *);
...
extern void dbri_keep_alive(caddr_t);
