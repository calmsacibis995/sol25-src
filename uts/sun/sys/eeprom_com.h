/*
 * Copyright (c) 1986, 1987, 1990 Sun Microsystems, Inc.
 */
...
#ifndef _SYS_EEPROM_COM_H
#define	_SYS_EEPROM_COM_H

#pragma ident	"@(#)eeprom_com.h	1.5	93/04/05 SMI"
/* From SunOS 4.1.1 mon/eeprom.h 1.30 */
...
/* 0x290 */	u_char	ee_logo[64][8];	/* A 64X64 bit space for custom/OEM */
					/* designed logo icon */
	    struct password_inf {
/* 0x490 */	u_short bad_counter;	/* illegal password count */
/* 0x492 */	char pw_mode;		/* Contains mode */
/* 0x494 */	char pw_bytes[8];	/* password */
	    } ee_password_inf;		/* Reserved for SFD */
