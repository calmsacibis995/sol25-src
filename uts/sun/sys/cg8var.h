...
#pragma ident	"@(#)cg8var.h	1.3	92/07/14 SMI"
...
#ifdef	__STDC__
static int cg8_ioctl(Pixrect *pr, int cmd, caddr_t data);
static int cg8_putattributes(Pixrect *pr, u_int *planesp);
static int cg8_putcolormap(Pixrect *pr, int index, int count,
