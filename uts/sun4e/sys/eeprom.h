...
#pragma ident	"@(#)eeprom.h	1.8	94/05/09 SMI"
...
#define	EE_SOFT_DEFINED	 /* tells ../sys/mon/eeprom.h to use this ee_soft */

#include <sys/mon/eeprom.h>
#endif /* !_ASM */

#define	OBIO_EEPROM_ADDR 0xE4000000	/* address of eeprom in obio space */
