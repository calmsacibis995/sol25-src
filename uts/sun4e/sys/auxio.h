...
#pragma ident	"@(#)auxio.h	1.5	92/07/14 SMI"
 ...
 * on sun4e machines.
 */
#define	OBIO_AUXIO_ADDR	0xEE800000	/* addr in obio space */
#define	AUXIO_ADDR	0xFFFF4000	/* virtual addr we map to */
#define	AUXIO_REG	0xFFFF4003	/* the address of the register */
