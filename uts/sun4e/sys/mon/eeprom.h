...
#pragma ident	"@(#)eeprom.h	1.8	93/04/05 SMI"
...
/* 0x18E */	u_char	ee_kb_id;	/* keyboard id in case of EEPROM tab */
...
/* 0x290 */	u_char	ee_logo[64][8];	/* A 64X64 bit space for custom/OEM */
					/* designed logo icon */
#ifdef PASSWORD
