...
#pragma ident	"@(#)clock.h	1.18	94/05/09 SMI"
 ...
 * on sun4e machines. These counters are normally used to generate
 * 100hz clock interrupts, but are fully programmable for whatever
 * purpose desired.
 */
#define	OBIO_COUNTER_ADDR	0xE6000000	/* addr in obio space */
#define	COUNTER_ADDR		0xFFFF6000	/* virtual addr we map to */
#ifndef _ASM
struct counterregs {
	u_int	counter10;
	u_int	limit10;
