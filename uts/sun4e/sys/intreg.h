...
#pragma ident	"@(#)intreg.h	1.7	92/07/14 SMI"
 ...
 */
#define	OBIO_INTREG_ADDR 0xEA000000	/* address in obio space */

#define	INTREG_ADDR	0xFFFFE000	/* virtual address we map it to */
