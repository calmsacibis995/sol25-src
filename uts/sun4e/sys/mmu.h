...
#pragma ident	"@(#)mmu.h	1.19	94/01/15 SMI"
...
/*
 * Sun-4e memory management unit.
 * All sun-4e implementations use 32 bits of address.
...
/* SUN4E_120 -- not in boot PROM */
#define	NCTXS_60		8
#define	NPMGRPS_60		256
 ...
 */
#define	SBUS_BASE	0xf0000000	/* address of Sbus slots in OBIO */
#define	SBUS_SIZE	0x04000000	/* size of each slot */
#define	SBUS_SLOTS	3		/* number of slots */
...
/*
 * Context for kernel. On a Sun-4e the kernel is in every address space,
