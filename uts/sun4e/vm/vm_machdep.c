...
#ident	"@(#)vm_machdep.c	1.31	94/11/08 SMI"
 ...
 */
int
valid_usr_range(register caddr_t addr, register u_int len)
{
...
void
page_freelist_sub(register page_t *pp)
{
	page_sub(&page_freelist, pp);
}

void
page_freelist_add(register page_t *pp)
{
