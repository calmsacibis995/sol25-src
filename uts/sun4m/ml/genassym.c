...
#pragma ident	"@(#)genassym.c	1.78	95/08/18 SMI"
...
/*	register struct zscom *zs = (struct zscom *)0;		XXX Payne */
	register struct as *as = (struct as *)0;
	register struct hat *hat = (struct hat *)0;
	register struct srmmu *srmmu = (struct srmmu *)0;
	register struct ctx *ctx = (struct ctx *)0;
	register label_t *l = 0;
	register struct count10 *cntr10 = (struct count10 *)0;
	register struct count14 *cntr14 = (struct count14 *)0;
	...
	/*
	 * locore.s uses N_NKL3PTS and N_NKL2PTS rather than
	 * NKL3PTS and NKL2PTS, respectively.
	 * see sun4m/sys/machparam.h
	 */
	printf("#define\tN_NKL2PTS ((0xFFFFFFFF - KERNELBASE + 1)/L2PTSIZE)\n");
	printf("#define\tN_NKL3PTS ((0xFFFFFFFF - KERNELBASE + 1)/L3PTSIZE)\n");
	...
	printf("#define\tGENERIC_PROTERR %d\n", SE_PROTERR);
	printf("#define\tGENERIC_INVALID %d\n", SE_INVALID);
	...
	printf("#define\tXC_PEND_HIPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_pend[X_CALL_HIPRI]));
	printf("#define\tXC_PEND_MEDPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_pend[X_CALL_MEDPRI]));
	printf("#define\tXC_PEND_LOPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_pend[X_CALL_LOPRI]));
	printf("#define\tXC_ACK_HIPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_ack[X_CALL_HIPRI]));
	printf("#define\tXC_ACK_MEDPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_ack[X_CALL_MEDPRI]));
	printf("#define\tXC_ACK_LOPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_ack[X_CALL_LOPRI]));
	printf("#define\tXC_WAIT_HIPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_wait[X_CALL_HIPRI]));
	printf("#define\tXC_WAIT_MEDPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_wait[X_CALL_MEDPRI]));
	printf("#define\tXC_WAIT_LOPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_wait[X_CALL_LOPRI]));

	printf("#define\tXC_STATE_HIPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_state[X_CALL_HIPRI]));
	printf("#define\tXC_STATE_MEDPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_state[X_CALL_MEDPRI]));
	printf("#define\tXC_STATE_LOPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_state[X_CALL_LOPRI]));
	printf("#define\tXC_RETVAL_HIPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_retval[X_CALL_HIPRI]));
	printf("#define\tXC_RETVAL_MEDPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_retval[X_CALL_MEDPRI]));
	printf("#define\tXC_RETVAL_LOPRI 0x%x\n",
		OFFSET(struct cpu, cpu_m.xc_retval[X_CALL_LOPRI]));

	{
	struct xc_mbox *xc_mboxes = 0;

	printf("#define\tXC_MBOX_FUNC_LOPRI 0x%x\n",
	    &xc_mboxes[X_CALL_LOPRI].func);
	printf("#define\tXC_MBOX_FUNC_MEDPRI 0x%x\n",
	    &xc_mboxes[X_CALL_MEDPRI].func);
	printf("#define\tXC_MBOX_FUNC_HIPRI 0x%x\n",
	    &xc_mboxes[X_CALL_HIPRI].func);

	printf("#define\tXC_MBOX_ARG1_LOPRI 0x%x\n",
	    &xc_mboxes[X_CALL_LOPRI].arg1);
	printf("#define\tXC_MBOX_ARG1_MEDPRI 0x%x\n",
	    &xc_mboxes[X_CALL_MEDPRI].arg1);
	printf("#define\tXC_MBOX_ARG1_HIPRI 0x%x\n",
	    &xc_mboxes[X_CALL_HIPRI].arg1);

	printf("#define\tXC_MBOX_ARG2_LOPRI 0x%x\n",
	    &xc_mboxes[X_CALL_LOPRI].arg2);
	printf("#define\tXC_MBOX_ARG2_MEDPRI 0x%x\n",
	    &xc_mboxes[X_CALL_MEDPRI].arg2);
	printf("#define\tXC_MBOX_ARG2_HIPRI 0x%x\n",
	    &xc_mboxes[X_CALL_HIPRI].arg2);

	printf("#define\tXC_MBOX_ARG3_LOPRI 0x%x\n",
	    &xc_mboxes[X_CALL_LOPRI].arg3);
	printf("#define\tXC_MBOX_ARG3_MEDPRI 0x%x\n",
	    &xc_mboxes[X_CALL_MEDPRI].arg3);
	printf("#define\tXC_MBOX_ARG3_HIPRI 0x%x\n",
	    &xc_mboxes[X_CALL_HIPRI].arg3);
	}
	...
	printf("#define\tCPU_IN_PROM 0x%x\n",
		OFFSET(struct cpu, cpu_m.in_prom));
	printf("#define\tBCOPY_RES 0x%x\n",
		OFFSET(struct cpu, cpu_m.bcopy_res));
	...
	printf("#define\tAHI_GETB 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_getb));
	printf("#define\tAHI_GETW 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_getw));
	printf("#define\tAHI_GETL 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_getl));
	printf("#define\tAHI_GETLL 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_getll));
	printf("#define\tAHI_PUTB 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_putb));
	printf("#define\tAHI_PUTW 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_putw));
	printf("#define\tAHI_PUTL 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_putl));
	printf("#define\tAHI_PUTLL 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_putll));
	printf("#define\tAHI_REP_GETB 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_rep_getb));
	printf("#define\tAHI_REP_GETW 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_rep_getw));
	printf("#define\tAHI_REP_GETL 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_rep_getl));
	printf("#define\tAHI_REP_GETLL 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_rep_getll));
	printf("#define\tAHI_REP_PUTB 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_rep_putb));
	printf("#define\tAHI_REP_PUTW 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_rep_putw));
	printf("#define\tAHI_REP_PUTL 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_rep_putl));
	printf("#define\tAHI_REP_PUTLL 0x%x\n",
		OFFSET(ddi_acc_impl_t, ahi_rep_putll));
