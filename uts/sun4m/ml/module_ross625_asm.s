...
#pragma ident	"@(#)module_ross625_asm.s	1.15	95/08/29 SMI"
...
{ }
	...
	bz,a	_sys_trap		! No, let sys_trap service it
	...
	ld	[%l4 + %l5], %l3	! read cpu[cpuindex]
        ...
        ! if (cpup->cpu_m.xc_pend[X_CALL_MEDPRI] == 0), goto sys_trap
	...
	tst	%l4
	bnz	_sys_trap		! Yes, go to sys_trap
	mov	(T_INTERRUPT | 13), %l4	! pass the intr # in %l4

        ! if (cpup->cpu_m.xc_state[X_CALL_MEDPRI] == XC_DONE), goto sys_trap
...
5:
	! if (xc_mboxes[X_CALL_MEDPRI].func != pgtlbflush), goto sys_trap
