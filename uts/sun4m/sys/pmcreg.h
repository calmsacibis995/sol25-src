...
#pragma ident	"@(#)pmcreg.h	1.5	94/12/02 SMI"
...
#define	PMC_KB_TEST		0x01	/* bit0 */
#define	PMC_KB_INTEN		0x02	/* bit1 */
#define	PMC_KB_STAT		0x04	/* bit2 */
#define	PMC_KB_INTR		0x08	/* bit3 */
