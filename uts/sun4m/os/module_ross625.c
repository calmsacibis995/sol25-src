...
#pragma ident	"@(#)module_ross625.c	1.14	95/08/07 SMI"
...
/*
 * CPU & CMTU revision levels
 */
#define	RT_REV_A1	0xA107		/* A.1 Silicon */
#define	RT_REV_A2	0xA207		/* A.2 Silicon */
#define	RT_REV_B0	0xB007		/* B.0 Silicon */
...
int virtual_bcopy;		/* use virtual bcopy */
 ...
 *
 *	RT620 Rev	PSR version	MCR version	DIAG
 *	-----------	-----------	-----------	----
 *
 *	A0		0x1F		0x17		  0
 *	A1		0x1F		0x17		  0
