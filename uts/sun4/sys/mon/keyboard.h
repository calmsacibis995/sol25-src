...
#ifndef _SYS_MON_KEYBOARD_H
#define	_SYS_MON_KEYBOARD_H

#pragma ident	"@(#)keyboard.h	1.13	92/07/14 SMI"
...
#define	KB_UNKNOWN	0xDE	/* Random unlikely to be seen */
				/* Changed to 0xDE for enough room  to expand */
...
#define	CTLSMASK	0x0100  	/* Set if ^S was last key of ^S, ^Q; */
...
#define	SHIFTKEYS	0x80	/* thru 0x8F.  This key helps to determine */
...
#define	BUCKYBITS	0x90	/* thru 0x9F.  This key determines the state */
