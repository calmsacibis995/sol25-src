...
#pragma ident "@(#)ramdata.h	1.13	94/01/17 SMI"	/* SVr4.0 1.3	*/
...
struct counts {		/* structure for keeping counts */
	...
	lwp_mutex_t mutex[2];	/* mutexes to replace SYSV semaphores */
...
extern	int	sys_args[9];	/* the arguments to last syscall */
...
extern	char	raw_sig_name[20]; /* name of known signal */
...
extern	char	exec_string[80];/* copy of sys_string for exec() only */
