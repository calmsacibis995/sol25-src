...
#ident	"@(#)n9.c	1.6	92/08/21 SMI"	/* SVr4.0 1.1	*/
...
int localize()
{
	...
	(void)getwidth(&eucwidth);
	eucsw[0] = 1;
	eucsw[1] = eucwidth._scrw1;
	eucsw[2] = eucwidth._scrw2;
	eucsw[3] = eucwidth._scrw3;
	euclocale = eucwidth._eucw1 + eucwidth._eucw2 + eucwidth._eucw3 +
		    eucwidth._scrw1 + eucwidth._scrw2 + eucwidth._scrw3;
