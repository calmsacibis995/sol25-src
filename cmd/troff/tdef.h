...
#ident	"@(#)tdef.h	1.6	94/03/30 SMI"	/* SVr4.0 1.1	*/
...
ifndef EUC
	...
	which is going to be a problem somewhere
		...
		bits 14,13	EUC codeset identifier
...
#ifdef EUC
#ifdef NROFF
#define CSMASK	0x6000	/* EUC codeset identifier */
#define MBMASK	0x1800	/* bits identifying position in a multibyte char */
#define FIRSTOFMB	0x0800
#define MIDDLEOFMB	0x1000
#define LASTOFMB	0x0000
#define	cs(n)	(((n) & CSMASK) >> 13)	/* EUC codeset number */
