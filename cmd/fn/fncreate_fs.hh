...
#pragma ident	"@(#)fncreate_fs.hh	1.1	94/12/05 SMI"
...
// Return a tree representing the input.
...
extern FNSP_Context *penultimate_ctx(FN_composite_name *name, bool_t &nsid);
...
extern void update_namespace(FNSP_Context *ctx, Dir *input,
    bool_t nsid = FALSE);
