...
#pragma ident "@(#)stats_log.c   1.18     94/11/11 SMI"
...
static char *stats_log_fmtfid(fid_t *);
...
stats_log_logfile_read(stats_cookie_t *st, int *type)
{
	...
	case CACHEFS_LOG_GETPAGE:
		if ((! xdr_int(xdrs, &getpage.error)) ||
		    (! xdr_long(xdrs, &getpage.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &getpage.vfsp,
		    sizeof (getpage.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &getpage.fid,
		    sizeof (getpage.fid))) ||
		    (! xdr_u_long(xdrs, &getpage.fileno)) ||
		    (! xdr_long(xdrs, &getpage.uid)) ||
		    (! xdr_u_int(xdrs, &getpage.offset)) ||
	...
	case CACHEFS_LOG_READDIR:
		if ((! xdr_int(xdrs, &readdir.error)) ||
		    (! xdr_long(xdrs, &readdir.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &readdir.vfsp,
		    sizeof (readdir.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &readdir.fid,
		    sizeof (readdir.fid))) ||
		    (! xdr_u_long(xdrs, &readdir.fileno)) ||
		    (! xdr_long(xdrs, &readdir.uid)) ||
		    (! xdr_long(xdrs, &readdir.offset)) ||
	...
	case CACHEFS_LOG_READLINK:
		if ((! xdr_int(xdrs, &readlink.error)) ||
		    (! xdr_long(xdrs, &readlink.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &readlink.vfsp,
		    sizeof (readlink.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &readlink.fid,
		    sizeof (readlink.fid))) ||
		    (! xdr_u_long(xdrs, &readlink.fileno)) ||
		    (! xdr_long(xdrs, &readlink.uid)) ||
		    (! xdr_u_int(xdrs, &readlink.length))) {
			stats_perror(st, SE_CORRUPT,
	...
	case CACHEFS_LOG_REMOVE:
		if ((! xdr_int(xdrs, &remove.error)) ||
		    (! xdr_long(xdrs, &remove.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &remove.vfsp,
		    sizeof (remove.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &remove.fid,
		    sizeof (remove.fid))) ||
		    (! xdr_u_long(xdrs, &remove.fileno)) ||
		    (! xdr_long(xdrs, &remove.uid))) {
			stats_perror(st, SE_CORRUPT,
	...
	case CACHEFS_LOG_RMDIR:
		if ((! xdr_int(xdrs, &rmdir.error)) ||
		    (! xdr_long(xdrs, &rmdir.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &rmdir.vfsp,
		    sizeof (rmdir.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &rmdir.fid,
		    sizeof (rmdir.fid))) ||
		    (! xdr_u_long(xdrs, &rmdir.fileno)) ||
		    (! xdr_long(xdrs, &rmdir.uid))) {
			stats_perror(st, SE_CORRUPT,
	...
	case CACHEFS_LOG_TRUNCATE:
		if ((! xdr_int(xdrs, &truncate.error)) ||
		    (! xdr_long(xdrs, &truncate.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &truncate.vfsp,
		    sizeof (truncate.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &truncate.fid,
		    sizeof (truncate.fid))) ||
		    (! xdr_u_long(xdrs, &truncate.fileno)) ||
		    (! xdr_long(xdrs, &truncate.uid)) ||
		    (! xdr_u_int(xdrs, &truncate.size))) {
			stats_perror(st, SE_CORRUPT,
	...
	case CACHEFS_LOG_PUTPAGE:
		if ((! xdr_int(xdrs, &putpage.error)) ||
		    (! xdr_long(xdrs, &putpage.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &putpage.vfsp,
		    sizeof (putpage.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &putpage.fid,
		    sizeof (putpage.fid))) ||
		    (! xdr_u_long(xdrs, &putpage.fileno)) ||
		    (! xdr_long(xdrs, &putpage.uid)) ||
		    (! xdr_u_int(xdrs, &putpage.offset)) ||
	...
	case CACHEFS_LOG_CREATE:
		if ((! xdr_int(xdrs, &create.error)) ||
		    (! xdr_long(xdrs, &create.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &create.vfsp,
		    sizeof (create.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &create.fid,
		    sizeof (create.fid))) ||
		    (! xdr_u_long(xdrs, &create.fileno)) ||
		    (! xdr_long(xdrs, &create.uid))) {
			stats_perror(st, SE_CORRUPT,
	...
	case CACHEFS_LOG_MKDIR:
		if ((! xdr_int(xdrs, &mkdir.error)) ||
		    (! xdr_long(xdrs, &mkdir.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &mkdir.vfsp,
		    sizeof (mkdir.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &mkdir.fid,
		    sizeof (mkdir.fid))) ||
		    (! xdr_u_long(xdrs, &mkdir.fileno)) ||
		    (! xdr_long(xdrs, &mkdir.uid))) {
			stats_perror(st, SE_CORRUPT,
	...
	case CACHEFS_LOG_SYMLINK:
		if ((! xdr_int(xdrs, &symlink.error)) ||
		    (! xdr_long(xdrs, &symlink.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &symlink.vfsp,
		    sizeof (symlink.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &symlink.fid,
		    sizeof (symlink.fid))) ||
		    (! xdr_u_long(xdrs, &symlink.fileno)) ||
		    (! xdr_long(xdrs, &symlink.uid)) ||
	...
	case CACHEFS_LOG_POPULATE:
		if ((! xdr_int(xdrs, &populate.error)) ||
		    (! xdr_long(xdrs, &populate.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &populate.vfsp,
		    sizeof (populate.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &populate.fid,
		    sizeof (populate.fid))) ||
		    (! xdr_u_long(xdrs, &populate.fileno)) ||
		    (! xdr_u_int(xdrs, &populate.off)) ||
		    (! xdr_int(xdrs, &populate.size))) {
			stats_perror(st, SE_CORRUPT,
	...
	case CACHEFS_LOG_GPFRONT:
		if ((! xdr_int(xdrs, &gpfront.error)) ||
		    (! xdr_long(xdrs, &gpfront.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &gpfront.vfsp,
		    sizeof (gpfront.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &gpfront.fid,
		    sizeof (gpfront.fid))) ||
		    (! xdr_u_long(xdrs, &gpfront.fileno)) ||
		    (! xdr_long(xdrs, &gpfront.uid)) ||
		    (! xdr_u_int(xdrs, &gpfront.off)) ||
	...
	case CACHEFS_LOG_RFDIR:
		if ((! xdr_int(xdrs, &rfdir.error)) ||
		    (! xdr_long(xdrs, &rfdir.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &rfdir.vfsp,
		    sizeof (rfdir.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &rfdir.fid,
		    sizeof (rfdir.fid))) ||
		    (! xdr_u_long(xdrs, &rfdir.fileno)) ||
		    (! xdr_long(xdrs, &rfdir.uid))) {
			stats_perror(st, SE_CORRUPT,
	...
	case CACHEFS_LOG_UALLOC:
		if ((! xdr_int(xdrs, &ualloc.error)) ||
		    (! xdr_long(xdrs, &ualloc.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &ualloc.vfsp,
		    sizeof (ualloc.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &ualloc.fid,
		    sizeof (ualloc.fid))) ||
		    (! xdr_u_long(xdrs, &ualloc.fileno)) ||
		    (! xdr_u_int(xdrs, &ualloc.off)) ||
	...
	case CACHEFS_LOG_CALLOC:
		if ((! xdr_int(xdrs, &challoc.error)) ||
		    (! xdr_long(xdrs, &challoc.time)) ||
		    (! xdr_opaque(xdrs, (caddr_t) &challoc.vfsp,
		    sizeof (challoc.vfsp))) ||
		    (! xdr_opaque(xdrs, (caddr_t) &challoc.fid,
		    sizeof (challoc.fid))) ||
		    (! xdr_u_long(xdrs, &challoc.fileno)) ||
		    (! xdr_u_int(xdrs, &challoc.off)) ||
...
stats_log_record_toascii(stats_cookie_t *st, void *recp)
{
	...
	case CACHEFS_LOG_MOUNT:
		...
		(void) sprintf(buffy, " %-8s %8x %8x %d %d %s (%s)",
		    "Mount", mountp->vfsp, mountp->flags, mountp->popsize,
		    mountp->fgsize, mountp->path,
		    mountp->path + mountp->pathlen + 1);
		(void) strcat(st->st_asciirec, buffy);
		break;

	case CACHEFS_LOG_UMOUNT:
		umountp = (struct cachefs_log_umount_record *) recp;
		(void) sprintf(buffy, " %-8s %8x", "Umount", umountp->vfsp);
		(void) strcat(st->st_asciirec, buffy);
		break;

	case CACHEFS_LOG_GETPAGE:
		getpagep = (struct cachefs_log_getpage_record *) recp;
		(void) sprintf(buffy, " %-8s %8x %s %lu %d %u %u", "Getpage",
	...
	case CACHEFS_LOG_READDIR:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d %x %d", "Readdir",
	...
	case CACHEFS_LOG_READLINK:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d %u", "Readlink",
		    readlinkp->vfsp,
	...
	case CACHEFS_LOG_REMOVE:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d", "Remove",
	...
	case CACHEFS_LOG_RMDIR:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d", "Rmdir",
	...
	case CACHEFS_LOG_TRUNCATE:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d %u", "Truncate",
		    truncatep->vfsp,
	...
	case CACHEFS_LOG_PUTPAGE:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d %u %u", "Putpage",
	...
	case CACHEFS_LOG_CREATE:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d", "Create",
		    createp->vfsp,
	...
	case CACHEFS_LOG_MKDIR:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d", "Mkdir",
		    mkdirp->vfsp,
	...
	case CACHEFS_LOG_RENAME:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d %d", "Rename",
		    renamep->vfsp,
	...
	case CACHEFS_LOG_SYMLINK:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d %u", "Symlink",
		    symlinkp->vfsp,
	...
	case CACHEFS_LOG_POPULATE:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %u %d", "Populate",
		    populatep->vfsp,
	...
	case CACHEFS_LOG_CSYMLINK:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d", "Csymlink",
		    csymlinkp->vfsp,
	...
	case CACHEFS_LOG_FILLDIR:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d", "Filldir",
		    filldirp->vfsp,
	...
	case CACHEFS_LOG_MDCREATE:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %u", "Mdcreate",
		    mdcreatep->vfsp,
	...
	case CACHEFS_LOG_GPFRONT:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d %u %u", "Gpfront",
		    gpfrontp->vfsp,
	...
	case CACHEFS_LOG_RFDIR:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %d", "Rfdir",
		    rfdirp->vfsp,
	...
	case CACHEFS_LOG_UALLOC:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %u %u", "Ualloc",
		    uallocp->vfsp,
	...
	case CACHEFS_LOG_CALLOC:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu %u %u", "Calloc",
		    callocp->vfsp,
	...
	case CACHEFS_LOG_NOCACHE:
		...
		(void) sprintf(buffy, " %-8s %8x %s %lu", "Nocache",
		    nocachep->vfsp,
...
stats_log_get_record_info(stats_cookie_t * sc,
    void *recp, caddr_t *vfsp, fid_t **fidp, u_long *filenop,
    off_t *offp, size_t *lenp)
{
	...
	case CACHEFS_LOG_READDIR:
		...
		*lenp = sc->st_loghead.lh_maxbsize;
		rc = (GRI_ADD | GRI_EXPENSIVE);
		break;
	...
	case CACHEFS_LOG_READLINK:
		...
		*vfsp = readlinkp->vfsp;
		*offp = 0;
		*lenp = (readlinkp->length > C_FSL_SIZE) ?
		    readlinkp->length : 0;
		rc = (GRI_ADD | GRI_EXPENSIVE);
		break;
	...
	case CACHEFS_LOG_SYMLINK:
		...
		*vfsp = symlinkp->vfsp;
		*offp = 0;
		*lenp = (symlinkp->size > C_FSL_SIZE) ? symlinkp->size : 0;
		rc = (GRI_ADD | GRI_MODIFY);
		break;
	...
	case CACHEFS_LOG_CSYMLINK:
		...
		*vfsp = csymlinkp->vfsp;
		*offp = 0;
		*lenp = (csymlinkp->size > C_FSL_SIZE) ? csymlinkp->size : 0;
		rc = GRI_ADD;
		break;
	...
	case CACHEFS_LOG_GPFRONT:
		...
		*vfsp = gpfrontp->vfsp;
		*offp = gpfrontp->off;
		*lenp = sc->st_loghead.lh_pagesize;
		rc = (GRI_ADD | GRI_EXPENSIVE);
		break;
...
void
stats_log_fi_add(stats_cookie_t *st, fid_info *fip, off_t off, size_t len)
{
	int i, j;
	off_t iend, jend;
	...
	iend = off & ~(st->st_loghead.lh_maxbsize - 1);

	jend = off + len;
	jend += st->st_loghead.lh_maxbsize - 1;
	jend &= ~(st->st_loghead.lh_maxbsize - 1);
	...
	for (i = fip->fi_total = 0; i < fip->fi_ent_n; i++)
...
void
stats_log_fi_trunc(stats_cookie_t *st, fid_info *fip, off_t off, size_t len)
{
	fip->fi_ent_n = 1;
...
stats_log_compute_wssize(stats_cookie_t *st)
{
	...
	mi = (mount_info *) malloc(sizeof (*mi) + MAXPATHLEN);
	if (mi == NULL) {
	...
	while (record = stats_log_logfile_read(st, &type)) {
		...
		case CACHEFS_LOG_MOUNT:
			...
			mi->mi_mounted = 1;
			(void) strcpy(mi->mi_path, mountp->path);
			(void) strcpy(mi->mi_path + mountp->pathlen + 1,
			    mountp->path + mountp->pathlen + 1);
			stats_dbm_store_byvfsp(st, mountp->vfsp, mi);
			break;
		...
		case CACHEFS_LOG_UMOUNT:
			...
			if (umountp->error != 0)
				break;
			mip = stats_dbm_fetch_byvfsp(st, umountp->vfsp);
			if (mip == NULL)
				break;
			mip->mi_mounted = 0;
			stats_dbm_store_byvfsp(st, umountp->vfsp, mip);
			free(mip);
			break;
		...
		default:
			...
			if (! mip->mi_used) {
				...
				mip->mi_current += lh->lh_maxbsize;
				st->st_ws_current += lh->lh_maxbsize;
			}

			/* add in the size-growth of the attrcache */
			delta = stats_dbm_attrcache_addsize(st, mip, fileno,
			    (type == CACHEFS_LOG_MDCREATE) ? len : 0);
			st->st_ws_current += delta;
			mip->mi_current += delta;
