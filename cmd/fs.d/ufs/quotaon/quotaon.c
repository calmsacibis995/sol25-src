...
#ident	"@(#)quotaon.c	1.17	94/08/16 SMI"	/* SVr4.0 1.9 */
/*
 * +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	char **argv;
{
	...
	/*
	 * Open temporary version of mnttab. But first, make sure we
	 * have a reasonable umask so we don't rename this with open
	 * permissions.
	 */
	umask(umask(0) | 022);
	tmp = fopen(tmpname, "w");
