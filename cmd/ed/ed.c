...
#ident	"@(#)ed.c	1.25	95/08/24 SMI"	/* SVr4.0 1.49.1.11	*/
...
static int	gsubf;		/* Occurrence value. 999=all. */
...
static char	*rshell = "/usr/bin/rsh";
static	char	*shpath; /* pointer to correct shell for execution of execlp() */
static char	*val;
static char	*home;
static int	nodelim;
...
static char	*place(register char *, register char *, register char *);
static void	comple(register wchar_t);
static void	putchr(unsigned char);
static void	putwchr(wchar_t);
static int	getchr(void);
static void	unixcom(void);
static void	blkio(int, char *, int (*)());
static void	reverse(register LINE, register LINE);
static void	putd();
