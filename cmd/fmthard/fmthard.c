...
#pragma ident	"@(#)fmthard.c	1.7	95/02/18 SMI"
 ...
 *
 * Note that fmthard cannot write a VTOC on a unlabeled disk.
 * You must use format or SunInstall for this purpose.
 *
 * The primary motification for fmthard is to duplicate the
