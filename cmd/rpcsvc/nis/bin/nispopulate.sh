#!/bin/sh
#
# @(#)nispopulate.sh	1.10 95/02/24	Copyright 1992 Sun Microsystems Inc.
...
init()
{
	...
	MAPS="auto_master auto_home ethers group hosts networks passwd protocols services rpc netmasks bootparams netgroup aliases timezone"
...
#  Do this be stripping comments and the running an awk script.
...
#
# add_cred(): populate the NIS+ credential from hosts or passwd
...
#  are used in do_cred to load the passwd & host tables.
#
##################################
print_passwd__add_cred()
{
...
#
#	Routine to print password for hosts, password table,
