/*
 * @(#)log.h	1.3 92/04/27   Copyright 1992 Sun Microsystems Inc.
 *
...
#pragma ident	"@(#)log.h	1.9	94/12/15 SMI"
...
/*
 * The update log is mapped into memory from the file <hostname>.log.
