 ...
 */
#ident	"@(#)main.c	1.9	95/04/07 SMI"

/*
 *  Time table
 *	xsh4_time -i input_fname [-f charmap] [-o output_fname] [-s skip_count]
 */
#include "time.h"
#include "extern.h"
#include <unistd.h>

#define	DEFAULT_OUTPUT	"time"
#define	OPTSTRING		":i:f:o:s:dc"
...
#define	TEXT_DOMAIN "SYS_TEST"
	...
	if ((fd = creat(output_fname, 0644)) == -1) {
		(void) fprintf(stderr, gettext(
			"%s: Can't create %s.\n"),
