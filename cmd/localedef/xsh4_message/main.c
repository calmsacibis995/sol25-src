 ...
 */
#ident	"@(#)main.c	1.10	95/03/06 SMI"

/*
 *  Message table
 *  xsh4_message -i input_fname [-f charmap] [-o output_fname] [-s skip_count]
 */
#include "message.h"
#include "extern.h"
#include <unistd.h>

#define	DEFAULT_OUTPUT	"message"
