...
#pragma ident "@(#)finger.c	1.18	95/07/25 SMI"
...
#ifdef SYSV
char USERLOG[] = "/var/adm/utmpx";	/* who is logged in */
#else
...
#define	CHAR_OK_FOR_TTY(c)	(isprint((int) c) || isspace((int) c))

void
catfile(s, mode, trunc_at_nl)
char *s;
mode_t mode;
int trunc_at_nl;
{
