...
#ident	"@(#)in.rlogind.c	1.16	94/12/05 SMI"	/* SVr4.0 1.9	*/
...
static void	protocol(int, int), rmut(), doit(int, struct sockaddr_in *);
...
rmut()
{
	...
	(void) ia_start("in.rlogind", ".rlogin",  NULL, NULL, NULL, &iah);
	/*
	 * No error checking for now.
	 */
	(void) ia_close_session(iah, 0, pid, 0, NULL, &out);
