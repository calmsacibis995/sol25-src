...
#ident	"@(#)interface.h	1.6	92/08/14 SMI"	/* SVr4.0 1.1	*/
...
#define IFF_NORIPOUT	0x100		/* Do not send RIP packets on if */
#define IFF_NORIPIN	0x200		/* Do not accept RIP packets on if */
