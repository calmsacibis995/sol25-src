...
#ident	"@(#)postio.c	1.10	94/12/13 SMI"	/* SVr4.0 1.2	*/
...
extern int	is_a_parallel_spif(int);
extern int	spif_state(int);
extern int	is_a_parallel_bpp(int);
extern int	bpp_state(int);
extern int	parallel_comm(int, int()); /* arg is spif_state or bpp_state */
