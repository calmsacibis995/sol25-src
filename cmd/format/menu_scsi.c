...
#pragma ident	"@(#)menu_scsi.c	1.7	94/09/25 SMI"
	...
	struct chg_list	*change_item;
{
	 ...
	 */
	if (apply_chg_list(pageno, length, (u_char *) saved,
			(u_char *) changeable, change_item)) {
		/*
...
do_inquiry()
{
	...
	fmt_print("\nInquiry:\n");
	dump("    ", inqbuf, inq->inq_len + 4, HEX_ASCII);
	fmt_print("\n");
