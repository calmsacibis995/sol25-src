...
#ifndef lint
#pragma ident	"@(#)menu_partition.c	1.9	95/02/18 SMI"
#endif	lint
...
"partition %c: specified # of blocks, %d, is out of range\n",
	...
	cur_parts->vtoc.v_part[i].p_start =
	    (daddr_t)(cur_parts->pinfo_map[i].dkl_cylno * (nhead * nsect));
...
/*ARGSUSED*/
void
print_partition(pinfo, partnum, want_header)
