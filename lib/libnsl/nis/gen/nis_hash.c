...
#pragma ident	"@(#)nis_hash.c	1.5	92/09/17 SMI"
 ...
 */
void
nis_flush_table(table, flush_func)
	NIS_HASH_TABLE	*table;
 ...
 */
void
nis_scan_table(table, func, funcarg)
	NIS_HASH_TABLE	*table;
