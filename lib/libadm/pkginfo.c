...
/*LINTLIBRARY*/
#ident	"@(#)pkginfo.c	1.9	95/04/04 SMI"	/* SVr4.0 1.2 */
...
extern FILE	*pkginfopen(char *pkgdir, char *pkginst);
...
extern  char 	*get_PKGLOC();
extern  char 	*get_PKGOLD();
