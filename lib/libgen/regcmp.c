...
#ident	"@(#)regcmp.c	1.13	94/04/20 SMI"	/* SVr4.0 1.1.4.2	*/
		...
		nlim:
			...
			*ep++ = i;
			...
			if (((int)(unsigned char)ep[-1]) <
				((int)(unsigned char)ep[-2])) goto cerror;
				continue;
