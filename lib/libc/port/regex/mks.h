...
typedef int mbstate_t;			/* Solaris porting mod */
...
LEXTERN	char	*basename (const char *);
...
LEXTERN	int	m_setprio (int, pid_t, int);
LEXTERN	int	m_getprio (int, pid_t);
LEXTERN int	m_incrnice (int, pid_t, int);
...
LEXTERN	int	m_dc_read (uchar *, int);
...
#define	M_FSATTR_ONE_DOT	0x08
#define	M_FSATTR_SHORT_EXT	0x10
#define	M_FSATTR_NO_LEADING_DOT	0x20
...
void _reginit(void);			/* Used to initialize coll routines */
#define wcschr wschr
#define wcslen wslen
#include <wctype.h>
#define m_realloc realloc
 ...
 */
#define	m_cclass	_m_cclass
#define	m_mbstowcsdup	_m_mbstowcsdup
#define	m_wcstombsdup	_m_wcstombsdup
#define	fexecve		_fexecve
#define	mbrtowc		_mbrtowc
#define	m_maxcoll	_m_maxcoll
#define	m_getmccoll	_m_getmccoll
#define	m_getwmccoll	_m_getwmccoll
#define	m_strtocoll	_m_strtocoll
#define	m_collrange	_m_collrange
#define	m_collequiv	_m_collequiv
#define	m_colltostr	_m_colltostr
#define	m_collorder	_m_collorder
#define	m_m_maxcoll	_m_m_maxcoll
#define	m_m_getmccoll	_m_m_getmccoll
#define	m_m_strtocoll	_m_m_strtocoll
#define	m_m_collrange	_m_m_collrange
#define	m_m_collequiv	_m_m_collequiv
#define	m_m_colltostr	_m_m_colltostr
#define	m_m_collorder	_m_m_collorder
#define	reg_m_mbstowcsdup	_reg_m_mbstowcsdup
#endif	/* __M_MKS_H__ */
