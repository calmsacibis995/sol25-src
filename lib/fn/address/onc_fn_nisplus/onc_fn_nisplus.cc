...
#pragma ident	"@(#)onc_fn_nisplus.cc	1.6	94/10/19 SMI"
...
extern "C"
FN_string_t *
onc_fn_nisplus__fn_ref_addr_description(const FN_ref_addr *addrt,
	unsigned detail, unsigned *more_detail)
{
	...
	FN_ref *nns_ref = 0;
	FN_string *nns_desc;
	int is_FNSP_addr = FNSP_nisplus_address_p(addr);
