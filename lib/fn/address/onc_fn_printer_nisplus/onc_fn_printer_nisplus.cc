...
#pragma ident	"@(#)onc_fn_printer_nisplus.cc	1.1	94/11/02 SMI"
...
extern "C"
FN_string_t *
onc_fn_printer_nisplus__fn_ref_addr_description(const FN_ref_addr *addrt,
	unsigned detail, unsigned *more_detail)
{
	...
	int is_FNSP_addr = FNSP_printer_nisplus_address_p(addr);
