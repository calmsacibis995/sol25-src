...
#pragma ident	"@(#)onc_fn_nis.cc	1.1	94/11/02 SMI"
...
static int
FNSP_nis_address_p(const FN_ref_addr &addr)
{
...
extern "C"
FN_string_t *
onc_fn_nis__fn_ref_addr_description(const FN_ref_addr *addrt,
	unsigned detail, unsigned *more_detail)
{
	...
	FN_ref *nns_ref = 0;
	FN_string *nns_desc;
	int is_FNSP_addr = FNSP_nis_address_p(addr);
