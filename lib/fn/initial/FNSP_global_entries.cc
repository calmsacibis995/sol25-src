...
#pragma ident "@(#)FNSP_global_entries.cc	1.4 94/10/07 SMI"
...
void
FNSP_InitialContext_GlobalEntry::resolve()
{
...
FNSP_InitialContext_GlobalDNSEntry::FNSP_InitialContext_GlobalDNSEntry()
{
	...
	stored_names[0] = new FN_string((unsigned char *)"dns");
}

void
FNSP_InitialContext_GlobalDNSEntry::resolve()
{
...
FNSP_InitialContext_GlobalX500Entry::FNSP_InitialContext_GlobalX500Entry()
{
	...
	stored_names[0] = new FN_string((unsigned char *)"x500");
}

void
FNSP_InitialContext_GlobalX500Entry::resolve()
{
