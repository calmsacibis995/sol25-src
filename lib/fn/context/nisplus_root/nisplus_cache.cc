...
#pragma ident "@(#)nisplus_cache.cc	1.1 95/01/29 SMI"

#include "cache_entry.h"  /* nis cache client  for NisDirCacheEntry */
...
add_to_cache(const directory_obj *dobj)
{
	...
	answer = __nis_CacheAddEntry(&res, (NisDirCacheEntry *)dobj);
