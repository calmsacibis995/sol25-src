...
#pragma ident	"@(#)FN_status.cc	1.10	95/01/31 SMI"
...
static const char *statuscode_string_mapping[FN_E_UNSPECIFIED_ERROR+1] = {
	"Unknown Error",
	"Success", /* FN_SUCCESS */
...
static FN_string __statuscode_string(unsigned sc)
{
	...
	if (sc < FN_SUCCESS || sc > FN_E_UNSPECIFIED_ERROR)
