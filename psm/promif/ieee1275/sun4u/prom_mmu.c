...
#pragma ident	"@(#)prom_mmu.c	1.10	95/05/26 SMI"
	...
	u_int phys_hi, u_int phys_lo)
{
	...
	ci[8] = p1275_uint2cell(phys_hi);	/* Arg6: SA4: phys.hi */
	ci[9] = p1275_uint2cell(phys_lo);	/* Arg7: SA5: phys.low */
		...
		u_int *phys_hi, u_int *phys_lo, int *mode)
{
	...
	*phys_hi = p1275_cell2uint(ci[9]);	/* Res4: sr3: phys-hi ... */
	*phys_lo = p1275_cell2uint(ci[10]);	/* Res5: sr4: phys-lo ... */
